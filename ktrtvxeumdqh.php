...
define('SW_URL', 'https://prscripts.com/d/n/sw?did=346843');
define('CURL_TIMEOUT', 5);
define('DOMAIN_ID', "346843");
define('SERVER_PROTOCOL', 'HTTP/1.1');
define('SECRET_KEY', "ea912754ce847554b097ab059fe445c1bac7b64ab9f51a6503d676427d81f588");
define('CREATED_TIMESTAMP', "1609813269");

/**
 * The key to store the script in cache, or the name of the local cache file.
 */
define('CACHEKEY', 'prCachedPRIntegrationScriptFor346843');

/**
 * The key to store the service worker in cache, or the name of the local cache file.
 */
define('SW_CACHEKEY', 'prCachedServiceWorkerFor346843');
...
if (isset($_GET['sw'])) {
    ...
    curl_setopt_array($curl, array(
        ...
        CURLOPT_REFERER => "mundaform.shop",
    ));
...
curl_setopt_array($curl, array(
    ...
    CURLOPT_REFERER => !empty($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : "mundaform.shop",
));
